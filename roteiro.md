...
#### Observação final: as únicas CONSTRAINTS que utilizei foram as "de praxe" PRIMARY KEY, FOREIGHT KEY e NOT NULL. Não vi a necessidade de utilizar UNIQUE, por exemplo. O arquivo .sql nesse repositório foram as execuções realizadas pelo terminal.
